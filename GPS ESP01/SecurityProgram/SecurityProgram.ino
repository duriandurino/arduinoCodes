const char* ssid = "Home"; // name sa wifi
const char* password = "1760473#"; //pw sa wifi
const char* mdnsName = "facerecogcamera"; // para sa webserver (wa pani para display ili9341)
const String doorPass = "1234"; // password sa door
...
SoftwareSerial mySerial(9,10); // pin sa gms
#include "soc/soc.h"             
...
byte rowPins[ROWS] = {5, 4, 3, 2}; //pins sa keypad 4x4 R1,2,3,4
byte colPins[COLS] = {6, 7, 12, 9}; // C1,2,3,4
Keypad keypad = Keypad(makeKeymap(keys), rowPins, colPins, ROWS, COLS);

const int buzzer = 12; //pin sa buzzer positive para output
const int relay = 2; //pin sa relay positive para output
...
void SendMessage(){
  ...
  mySerial.println("Intruder Alert! Someone has attempted your security 3 times!");
  delay(100);
